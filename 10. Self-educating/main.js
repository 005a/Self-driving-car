...
function animate(time){
    ...
    {
        road.progress++;
         if(road.progress>road.bestProgress)
        {
road.bestProgress=road.progress;
 ...
 let randomLane=Math.round( (Math.random()*13)%3);
        ...
        traffic.push( new Car(road.getLaneCenter(Math.round( (Math.random()*13)%3)),lastDummyCar.y-300,30,50,"DUMMY",2,getRandomColor()));
      ...
      traffic.push( new Car(road.getLaneCenter(Math.round( (Math.random()*13)%3)),lastDummyCar.y-500,30,50,"DUMMY",2,getRandomColor()));
